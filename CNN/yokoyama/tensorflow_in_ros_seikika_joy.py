...
class RosTensorFlow():
    def __init__(self):
        ...
        self._pub = rospy.Publisher('/ypspur_ros/cmd_vel', Twist, queue_size=10)#TODO
    ...
    def callback(self):
         ...
         if(self.sub_image0_flag==1):
            ...
            joy_vel = self.joy_msg1 * 0.3 #please change velocity from 0.3
            ...
            if (vel > 0.05):
                stre = self.joy_msg2 * 0.3
            elif (vel < -0.05):
                stre = self.joy_msg2 * 0.3 * (-1)
            else:
                stre = 0
    ...
    def callback_joy(self, joy_msg):
        ...
        self.joy_msg1 = joy_msg.axes[1]
        self.joy_msg2 = joy_msg.axes[2]
        self.callback()
