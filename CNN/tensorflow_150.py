...
class RosTensorFlow():
    def __init__(self):
        ...
        self.cv_image = np.zeros((150,150,1), np.uint8)
        self.cv_image1 = np.zeros((1,150,150,1), np.uint8)


        # self.twist = Twist()

        self._cv_bridge = CvBridge()
        self._sub1 = rospy.Subscriber('/image_', Image, self.callback_image, queue_size=1)
        ...
        self.x = tf.compat.v1.placeholder(tf.float32, [None,150,150,1], name="x")
        ...
        self._saver.restore(self._session, "model/0226-3-2-1.ckpt")
    ...
    def callback_image(self,image_msg):
        ...
        self.cv_image1 = np.reshape(self.cv_image, [1, 150, 150, 1])/255.0
