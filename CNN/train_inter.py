...
answer_file = "/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-16-01-41"
filenames = [
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-15-53-56",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-15-54-46",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-15-55-39",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-15-56-37",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-15-57-21",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-16-00-16",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-16-20-23",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-16-23-41",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-17-05-03"
]
...
while(l<=10000):
	...
	for i in range(itter):
		...
		if(l%100 == 0):
			...
			f = open("loss/0225-test.txt","a")
			if(rmse<trainrmse):
				trainrmse=rmse
				save_path = saver.save(sess, "model/0225-test.ckpt")
				f.write("%d, %f\n" %(l,rmse))
