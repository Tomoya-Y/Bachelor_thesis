...
filenames = ["/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-23-20-33-52",
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-23-20-40-46",
...
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-23-20-59-50",
...
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-23-21-28-52",
...
"/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-23-21-54-26",
...
while(l<=10000):
	...
	for i in range(itter):
		...
		if(l%100 == 0):
			...
			f = open("loss/0223-4-1-0.txt","a")
			if(rmse<trainrmse):
				trainrmse=rmse
				save_path = saver.save(sess, "model/0223-4-1-0.ckpt")
				f.write("%d, %f\n" %(l,rmse))
