...
#define SENSITIVITY_STEER 1.5  /*rad/(rad/m)*/
#define SENSITIVITY_VEL 1.5    /*rad/(m/s)*/
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber m_motion_sub = n.subscribe("dx/twist_cmd_in", 10, cmd_callback);
