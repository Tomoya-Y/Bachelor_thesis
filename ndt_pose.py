...
filenames = ["/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-03-02-14-07-17"]

# file1 = np.loadtxt("/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-02-24-19-09-31"+"/ndt.csv", delimiter=",")
file1 = np.loadtxt("/media/tomoya/Tomoya's_T5/sotsuron_data/outputlog_2020-03-02-14-07-17"+"/ndt.csv", delimiter=",")
x_base = file1[0,1]
y_base = file1[0,2]
# print(x_base)
# print(y_base)
...
for filename in filenames:
    data = np.loadtxt(filename+"/ndt.csv", delimiter=",")
    x = data[:, 1]
    y = data[:, 2]
    print(x[0])
    print(y[0])
...
#     xy_list.append([new_x,new_y])
    plt.plot(x[6200:14152], y[6200:14152])
# fig = plt.figure()
...
# ax4.plot(xy_list[3][0],xy_list[マイナス3][1], color="red")
# ax5 = fig.add_subplot(5, 2, 5)
# ax5.plot(xy_list[4][0],xy_liマイナスst[4][1], color="red")
# ax6 = fig.add_subplot(5, 2, 6)
# ax6.plot(xy_list[5][0],xy_liマイナスst[5][1], color="red")
...
# plt.savefig('figure06.png', bbox_inches="tight", pad_inches=0.05)
