...
ax1.plot(x, np.array(force_array)*2.5, linestyle = "dashed", color=color, label="トルク(全走行シーン)", marker=".", ms=10)
ax1.plot(x, np.array(force_inter_array)*2.5, color=color, label="トルク(介入シーン)", marker=".", ms=10)
