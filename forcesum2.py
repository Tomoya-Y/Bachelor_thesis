...
first_file = "/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-09-50-55/force.csv"
first_force = np.loadtxt(first_file, delimiter=",", usecols=1)

#from filenames1 to filenames3: learn from all data
filenames1 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-10-10-31/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-10-11-19/force.csv"
]

filenames2 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-10-54-53/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-10-55-43/force.csv"
]

filenames3 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-11-32-22/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-11-33-46/force.csv"
]

filenames4 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-12-10-53/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-12-11-41/force.csv"
]
...
filenames8 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-10-10-31/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-10-11-19/force.csv"
]

filenames9 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-11-03-15/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-11-04-12/force.csv"
]

filenames10 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-11-41-26/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-11-42-13/force.csv"
]

filenames11 = ["/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-12-19-55/force.csv",
"/media/tomoya/Tomoya's_T5/202001data/outputlog_2020-01-27-12-20-46/force.csv"
]
